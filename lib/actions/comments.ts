...
export async function listPublicComments(page: number, pageSize: number) {
  return getPublicCommentsPage(page, pageSize);
}
export const listAdminComments = loadAdminComments;
