Feature: Admin Dashboard settings
    ...
    Rule: Admin Dashboard settings apply changes
        ...
        Scenario: Admin can update the guestbook title
            ...
            And those changes are applied to the standalone guestbook page
        ...
        Scenario: Admin can set a custom comment length
            ...
            And they click the `save changes` button
            Then those new limits are applied to the standalone guestbook commenting
            And those new limits are applied to the main Original Poetry landing guestbook commenting
        ...
        Scenario: Admin can allow-list profanity
            ...
            And they click the `save changes` button
            Then those new allowances are applied to the standalone guestbook commenting
            And those new allowances are applied to the main Original Poetry landing guestbook commenting
